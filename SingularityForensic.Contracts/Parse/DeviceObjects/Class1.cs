namespace SingularityForensic.Contracts.Parse.DeviceObjects {
    ////未知分区，尚未细分;
    //public class UnknownParititon : Partition {
    //    /// <summary>
    //    /// 其他分区的构造方法;
    //    /// </summary>
    //    /// <param name="parent">父文件为设备</param>
    //    ///<param name="partTabInfo">分区结构（自定义）</param>
    //    public UnknownParititon(TabPartInfo partTabInfo, Device parent) : base(parent) {
    ...
    //                }
    //                else {
    //                    Logger.WriteLine($"{nameof(UnknownParititon)}->{nameof(LoadContent)}:Wrong FsType-{TabPartInfo.FSType}");
    //                    return;
    //                }
    //                #endregion
    //            }
    //            else {
    //                Logger.WriteLine($"{nameof(UnknownParititon)}->{nameof(LoadContent)}:Failed to convert to Device.");
    //            }
    //        }
    //        else {
    //            Logger.WriteLine($"{nameof(UnknownParititon)}->{nameof(LoadContent)}:value can't be null-{nameof(TabPartInfo)}");
    //        }
    //    }
