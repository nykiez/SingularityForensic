...
namespace SingularityForensic.Hex {
    ...
    public static partial class MenuItemDefinitions {
        ...
        public static MenuButtonItem SearchKeyMenuItem {
            get {
                if (_searchKeyMenuItem == null) {
                    _searchKeyMenuItem = new MenuButtonItem(MenuConstants.MenuGroupGUID_Tools, ServiceProvider.Current?.GetInstance<ILanguageService>()?.FindResourceString("IndexSearch")) {
        ...
        public static MenuButtonItem FindTextMenuItem
              => _findTextMenuItem ?? (_findTextMenuItem = new MenuButtonItem(MenuConstants.MenuGroupGUID_Tools,
        ...
        public static MenuButtonItem FindHexMenuItem
            => _findHexMenuItem ?? (_findHexMenuItem = new MenuButtonItem(MenuConstants.MenuGroupGUID_Tools,
        ...
        public static MenuButtonItem GoToOffsetMenuItem
           ...
           MenuConstants.MenuGroupGUID_Tools,
