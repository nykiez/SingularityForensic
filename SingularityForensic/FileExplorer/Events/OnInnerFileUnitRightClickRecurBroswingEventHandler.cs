...
namespace SingularityForensic.FileExplorer.Events {
    ...
    public class OnInnerFileUnitRightClickRecurBroswingEventHandler : EventHandlerBase<(ITreeUnit unit, ITreeService treeService)>, ITreeUnitRightClickedEventHandler {
