...
namespace SingularityForensic.FileExplorer {
    [Export]
    public partial class FileExplorerUIReactServiceForPartition {
        [ImportingConstructor]
        public FileExplorerUIReactServiceForPartition([ImportMany]IEnumerable<IPreviewProvider> previewerProviders) {
        ...
        private void RegisterEvents() {
            ...
            //分区选中行发生变更时更新响应;
            PubEventHelper.GetEvent<FocusedFileRowChangedEvent>().Subscribe(tuple => {
                //分区选中行发生变更时,更新十六进制变化;
