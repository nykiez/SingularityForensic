namespace SingularityForensic.ITunes {
    ...
    /// </summary>
    public static partial class Constants {
        public const string InvalidItunesBPath = nameof(InvalidItunesBPath);

        public const string MenuItemText_AddITunesBackupDir = nameof(MenuItemText_AddITunesBackupDir);
