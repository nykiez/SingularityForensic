...
namespace SingularityForensic.NTFS {
    ...
    struct LogFileRSTRHeaderStruct {
    ...
    //    public LogFileRSTRHeader(byte[] data) {
    //        this.Data = data ?? throw new ArgumentNullException(nameof(data));
    //        if (data.Length != RSTRHeaderSize) {
    //            throw new ArgumentException($"The length of {nameof(data)} is not valid({RSTRHeaderSize}).");
    //        }
