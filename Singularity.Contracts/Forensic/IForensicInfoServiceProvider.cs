...
namespace Singularity.Contracts.Forensic {
    ...
    /// 以下为针对安卓镜像示例;
    /// </summary>
    [Export(Singularity.Contracts.Case.Constants.AndroidDeviceImg, typeof(IForensicInfoServiceProvider))]
    public class AdImgInfoForensicInfoServiceProviderExample : IForensicInfoServiceProvider {
        public IEnumerable<ITreeUnit> GetInfoesUnit(ICaseEvidence csEvidence) => throw new NotImplementedException();

        public void Load(ICaseEvidence caseEvidence) => throw new NotImplementedException();
        ...
        IEnumerable<ForensicTreeUnit> IForensicInfoServiceProvider.GetInfoesUnit(ICaseEvidence csEvidence) {
