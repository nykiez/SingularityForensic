...
namespace Singularity.UI.MessageBoxes.Windows {
    ...
    public partial class SignSearchWindow : CorneredWindow {
        ...
        private bool CheckHex() {
            if(HexValue == null) {
                txbSignError.Text = HexValue == null ? FindResourceString("InvalidHex") : string.Empty;
                return false;
            }
            else {
        ...
        private bool CheckSecSize() {
            if (SecSize != null && SecSize >= 512 && SecSize <= 4096) {
                ...
                txbSecSizeError.Text = FindResourceString("InvalidSecSize");
                return false;
            }
        }
        ...
        private bool CheckSecOffset() {
            if (SecStartLBA != null && SecStartLBA >= 0 && SecStartLBA < ( SecSize ?? 512 ) ) {
                ...
                txbStartLBAError.Text = FindResourceString("InvalidSecOffset");
                return false;
            }
        }
        ...
        private bool CheckMaxSize() {
            if(MaxSize != null && MaxSize >= 1 && MaxSize <= 1024){
                ...
                txbMaxSizeError.Text = FindResourceString("InvalidMaxFileSize");
                return false;
            }
        }
